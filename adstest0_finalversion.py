...
class ADS:
    ...
    def Initiate(self):
        ...
        self.Reg_Write(REG_CONFIG1, 0x00000000) 		#Set sampling rate to 500 SPS
        time.sleep(0.01)
        ...
        time.sleep(0.01)
        self.Reg_Write(REG_CH2SET, 0b00000000)	#Ch 2 enabled, gain 12, test signal
        time.sleep(0.01)
